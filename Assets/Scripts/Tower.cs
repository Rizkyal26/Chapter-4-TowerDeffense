...
public class Tower : MonoBehaviour
{
    ...
    internal void SetPlacePos(Vector3 position)
    {
    ...
    {  
        ...
        _towerPlace.sortingOrder = (int)orderInLayer;
        _towerHead.sortingOrder = (int)orderInLayer;
    }
    ...
    internal void SetPlacePosition(object p)
    {
        throw new NotImplementedException();
    }
}